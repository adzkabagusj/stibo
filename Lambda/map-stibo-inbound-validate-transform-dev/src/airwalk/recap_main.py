...
# Source: "Airwalk Mapping Issues and References.xlsx" → sheet "BY Age & Gender".
# Keys are upper-case with spaces removed (compare through _hkey()).
# recap "Gender" → (SAP Gender display, BY Gender display)
AIRWALK_GENDER_MAP: dict[str, tuple[str, str]] = {
...
AIRWALK_AGE_GROUP_MAP: dict[str, tuple[str, str]] = {
...
AIRWALK_GENDER_TO_AGE_GROUP: dict[str, str] = {
...
def _resolve_gender_age(mapped: dict, md_mapping=None) -> None:
    ...
    sap_g, by_g = AIRWALK_GENDER_MAP.get(_hkey(gender_raw), ("", ""))
