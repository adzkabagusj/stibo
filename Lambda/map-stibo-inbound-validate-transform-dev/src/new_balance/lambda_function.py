...
#     /tmp/stibo_workdir/input/naming/

# Global files (mdd, naming) are fetched from raw/metadata/ root.
...
# #   5. mdd / attributes / naming  — shared global support files
# #
# # ─────────────────────────────────────────────────────────────────────────────
...
# #
# #   Non-linelist types always required: mdd, attributes, naming
# #   Plus at least ONE linelist/ecommerce type.
# # ─────────────────────────────────────────────────────────────────────────────
# REQUIRED_NON_LINELIST_TYPES: set[str] = {"mdd", "attributes", "naming"}

# # Required types per triggered file type (mirrors NB Licensed logic)
# REQUIRED_TYPES_BY_TRIGGER: dict[str, set[str]] = {
#     "linelist_apparel":   {"linelist_apparel",   "mdd", "attributes", "naming"},
#     "linelist_footwear":  {"linelist_footwear",  "mdd", "attributes", "naming"},
#     "linelist_licensed":  {"linelist_licensed",  "mdd", "attributes", "naming"},
#     "ecommerce_licensed": {"ecommerce_licensed", "mdd", "attributes", "naming"},
#     "ecommerce_inline":   {"ecommerce_inline",   "mdd", "attributes", "naming"},
#     "ean_source": {"ean_source", "mdd"},
#     "ordersheet_licensed":  {"ordersheet_licensed", "mdd", "attributes", "naming"},
# }
...
#     Otherwise fall back to: mdd + attributes + naming + at least one linelist/ecommerce.
#     """
...
#         # season = re.sub(
#         #     r'^(FW|SS|AL)(20)(\d{2})$',
#         #     lambda x: f"{x.group(1)}{x.group(3)}",
#         #     season,
#         #     flags=re.IGNORECASE,
#         # ).upper()
